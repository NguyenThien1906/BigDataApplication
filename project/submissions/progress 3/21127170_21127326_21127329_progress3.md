...
- RS model training using Big Data techniques. [Not done]
...
|3|Kiệt|Model training on full dataset. <br><br> Model visualization on Matplotlib|Model training on full dataset. <br><br> Model visualization on Matplotlib|None.|Model training on full dataset with the current output of other phases to a model file.<br><br> Model visualization on Matplotlib|??|
